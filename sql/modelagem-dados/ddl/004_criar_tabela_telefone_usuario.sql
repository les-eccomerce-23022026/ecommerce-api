...
-- O número de telefone é armazenado completo (DDD + número) em um único campo.
--
...
--   • tel_numero: 10 ou 11 dígitos (DDD + número, somente números).
...
CREATE TABLE IF NOT EXISTS livraria_gestao.telefones (
    ...
    CONSTRAINT uq_telefones_usuario_numero   UNIQUE (usu_id, tel_numero),
