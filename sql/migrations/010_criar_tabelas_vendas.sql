...
CREATE TABLE IF NOT EXISTS livraria_comercial.ecm_status_venda (
...
-- Tabela de Vendas
CREATE TABLE IF NOT EXISTS livraria_comercial.ecm_venda (
    ven_id BIGSERIAL PRIMARY KEY,
    ven_uuid UUID NOT NULL DEFAULT gen_random_uuid() UNIQUE,
    usu_id BIGINT NOT NULL,
    stv_id INTEGER NOT NULL REFERENCES livraria_comercial.ecm_status_venda(stv_id),
    ...
    CONSTRAINT fk_venda_usuario FOREIGN KEY (usu_id) REFERENCES livraria_gestao.usuarios(usu_id)
);

-- Tabela de Itens de Venda
CREATE TABLE IF NOT EXISTS livraria_comercial.ecm_item_venda (
...
CREATE INDEX IF NOT EXISTS idx_venda_usuario ON livraria_comercial.ecm_venda(usu_id);
CREATE INDEX IF NOT EXISTS idx_venda_status ON livraria_comercial.ecm_venda(stv_id);
CREATE INDEX IF NOT EXISTS idx_item_venda_uuid ON livraria_comercial.ecm_item_venda(itv_uuid);
CREATE INDEX IF NOT EXISTS idx_item_venda_venda ON livraria_comercial.ecm_item_venda(ven_id);
