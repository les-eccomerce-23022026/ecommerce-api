...
-- Objetivos: Criar cupons DESCONTO10, DESCONTO20, TROCA50, TROCA30 para testes

-- Inserir cupons de teste
INSERT INTO cupom (cup_codigo, cup_tipo, cup_valor_desconto, cup_valor_minimo, cup_valido_de, cup_valido_ate, cup_ativo) VALUES
...
COMMENT ON TABLE cupom IS 'Seed de cupons para testes E2E do Cypress';
