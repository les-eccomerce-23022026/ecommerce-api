...
INSERT INTO tipo_frete (tfr_descricao) VALUES
('PAC'),
('SEDEX'),
('RETIRA_EM_LOJA')
...
CREATE TABLE IF NOT EXISTS entrega (
  ...
  ven_id INTEGER NOT NULL REFERENCES ecm_venda(ven_id) ON DELETE CASCADE,
  tfr_id INTEGER NOT NULL REFERENCES tipo_frete(tfr_id),
...
CREATE INDEX IF NOT EXISTS idx_entrega_uuid ON entrega(ent_uuid);
CREATE INDEX IF NOT EXISTS idx_entrega_venda ON entrega(ven_id);
CREATE INDEX IF NOT EXISTS idx_entrega_tipo_frete ON entrega(tfr_id);
