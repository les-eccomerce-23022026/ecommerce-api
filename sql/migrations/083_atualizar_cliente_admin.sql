-- Migration 083: Atualizar demo.cliente01@les.demo.br para ter permissões de admin_sistema
-- Email: demo.cliente01@les.demo.br | Senha: Cliente@123 (do seed 065)
...
BEGIN
    ...
    -- Buscar usuário demo.cliente01@les.demo.br
    SELECT usu_id, loj_id INTO v_usu_id, v_loj_id 
    FROM livraria_gestao.usuarios 
    WHERE usu_email = 'demo.cliente01@les.demo.br' 
    LIMIT 1;

    IF v_usu_id IS NULL THEN
        RAISE EXCEPTION 'Usuário demo.cliente01@les.demo.br não encontrado';
    END IF;
    ...
    RAISE NOTICE 'Usuário demo.cliente01@les.demo.br atualizado com permissões de admin_sistema';
    RAISE NOTICE 'Escopo: SISTEMA (acesso a todas as lojas)';
    RAISE NOTICE 'Senha: Cliente@123 (do seed 065)';
END $$;
