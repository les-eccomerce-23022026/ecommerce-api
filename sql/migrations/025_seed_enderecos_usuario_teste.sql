...
-- DESCONTINUADO: Este seed foi consolidado em migrations/035_seed_checkout_bdd_clientetest.sql
-- Este arquivo não deve ser executado para evitar duplicação de dados
-- Data: 2026-04-28
-- Correção: Marcado como descontinuado em 2026-05-22 para evitar duplicação de endereços
