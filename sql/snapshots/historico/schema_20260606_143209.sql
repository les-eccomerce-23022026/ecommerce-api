...
--
-- Name: ecm_item_venda; Type: TABLE; Schema: livraria_comercial; Owner: -
--
...
--
-- Name: ecm_item_venda_itv_id_seq1; Type: SEQUENCE; Schema: livraria_comercial; Owner: -
--

CREATE SEQUENCE livraria_comercial.ecm_item_venda_itv_id_seq1
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ecm_item_venda_itv_id_seq1; Type: SEQUENCE OWNED BY; Schema: livraria_comercial; Owner: -
--

ALTER SEQUENCE livraria_comercial.ecm_item_venda_itv_id_seq1 OWNED BY livraria_comercial.ecm_item_venda.itv_id;


--
-- Name: ecm_status_venda; Type: TABLE; Schema: livraria_comercial; Owner: -
--

CREATE TABLE livraria_comercial.ecm_status_venda (
...
--
-- Name: ecm_status_venda_stv_id_seq1; Type: SEQUENCE; Schema: livraria_comercial; Owner: -
--

CREATE SEQUENCE livraria_comercial.ecm_status_venda_stv_id_seq1
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: ecm_status_venda_stv_id_seq1; Type: SEQUENCE OWNED BY; Schema: livraria_comercial; Owner: -
--

ALTER SEQUENCE livraria_comercial.ecm_status_venda_stv_id_seq1 OWNED BY livraria_comercial.ecm_status_venda.stv_id;


--
-- Name: ecm_venda; Type: TABLE; Schema: livraria_comercial; Owner: -
--
...
--
-- Name: ecm_venda_ven_id_seq1; Type: SEQUENCE; Schema: livraria_comercial; Owner: -
--

CREATE SEQUENCE livraria_comercial.ecm_venda_ven_id_seq1
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ecm_venda_ven_id_seq1; Type: SEQUENCE OWNED BY; Schema: livraria_comercial; Owner: -
--

ALTER SEQUENCE livraria_comercial.ecm_venda_ven_id_seq1 OWNED BY livraria_comercial.ecm_venda.ven_id;
...
--
-- Name: ecm_item_venda itv_id; Type: DEFAULT; Schema: livraria_comercial; Owner: -
--

ALTER TABLE ONLY livraria_comercial.ecm_item_venda ALTER COLUMN itv_id SET DEFAULT nextval('livraria_comercial.ecm_item_venda_itv_id_seq1'::regclass);


--
-- Name: ecm_status_venda stv_id; Type: DEFAULT; Schema: livraria_comercial; Owner: -
--

ALTER TABLE ONLY livraria_comercial.ecm_status_venda ALTER COLUMN stv_id SET DEFAULT nextval('livraria_comercial.ecm_status_venda_stv_id_seq1'::regclass);


--
-- Name: ecm_venda ven_id; Type: DEFAULT; Schema: livraria_comercial; Owner: -
--

ALTER TABLE ONLY livraria_comercial.ecm_venda ALTER COLUMN ven_id SET DEFAULT nextval('livraria_comercial.ecm_venda_ven_id_seq1'::regclass);
...
--
-- Name: ecm_item_venda ecm_item_venda_itv_uuid_key1; Type: CONSTRAINT; Schema: livraria_comercial; Owner: -
--
...
--
-- Name: ecm_item_venda ecm_item_venda_pkey1; Type: CONSTRAINT; Schema: livraria_comercial; Owner: -
--
...
--
-- Name: ecm_status_venda ecm_status_venda_pkey1; Type: CONSTRAINT; Schema: livraria_comercial; Owner: -
--

ALTER TABLE ONLY livraria_comercial.ecm_status_venda
...
--
-- Name: ecm_status_venda ecm_status_venda_stv_descricao_key1; Type: CONSTRAINT; Schema: livraria_comercial; Owner: -
--
...
--
-- Name: ecm_venda ecm_venda_pkey1; Type: CONSTRAINT; Schema: livraria_comercial; Owner: -
--
...
--
-- Name: ecm_venda ecm_venda_ven_uuid_key1; Type: CONSTRAINT; Schema: livraria_comercial; Owner: -
--
...
CREATE TRIGGER tg_cartoes_atualizado_em BEFORE UPDATE ON livraria_financeiro.cartoes FOR EACH ROW EXECUTE FUNCTION public.fn_atualizar_timestamp();
...
--
-- Name: ecm_item_venda ecm_item_venda_ven_id_fkey1; Type: FK CONSTRAINT; Schema: livraria_comercial; Owner: -
--
...
--
-- Name: ecm_venda ecm_venda_stv_id_fkey1; Type: FK CONSTRAINT; Schema: livraria_comercial; Owner: -
--

ALTER TABLE ONLY livraria_comercial.ecm_venda
    ADD CONSTRAINT ecm_venda_stv_id_fkey1 FOREIGN KEY (stv_id) REFERENCES livraria_comercial.ecm_status_venda(stv_id);
...
--
-- Name: ecm_venda fk_venda_usuario; Type: FK CONSTRAINT; Schema: livraria_comercial; Owner: -
--
