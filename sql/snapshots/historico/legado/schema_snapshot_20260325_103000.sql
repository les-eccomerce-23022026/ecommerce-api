...
\restrict iPHLNda8EeZuY3h2fAciakkbpy7g0r6dWYzTO1ym1il0SJWrEb50kktRfUU20ps
...
--
-- Name: ecm_cartao_pagamento; Type: TABLE; Schema: public; Owner: ecm_user
--

CREATE TABLE public.ecm_cartao_pagamento (
    crp_id integer NOT NULL,
    pag_id integer NOT NULL,
    crp_numero_tokenizado character varying(255) NOT NULL,
    crp_nome_titular character varying(100) NOT NULL,
    crp_validade character varying(5) NOT NULL,
    crp_bandeira character varying(50) NOT NULL,
    crp_criado_em timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


ALTER TABLE public.ecm_cartao_pagamento OWNER TO ecm_user;

--
-- Name: ecm_cartao_pagamento_crp_id_seq; Type: SEQUENCE; Schema: public; Owner: ecm_user
--

CREATE SEQUENCE public.ecm_cartao_pagamento_crp_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.ecm_cartao_pagamento_crp_id_seq OWNER TO ecm_user;

--
-- Name: ecm_cartao_pagamento_crp_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ecm_user
--

ALTER SEQUENCE public.ecm_cartao_pagamento_crp_id_seq OWNED BY public.ecm_cartao_pagamento.crp_id;
...
--
-- Name: ecm_pagamento; Type: TABLE; Schema: public; Owner: ecm_user
--

CREATE TABLE public.ecm_pagamento (
    pag_id integer NOT NULL,
    ...
    pag_criado_em timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    pag_processado_em timestamp without time zone,
    CONSTRAINT ecm_pagamento_pag_valor_check CHECK ((pag_valor > (0)::numeric))
);


ALTER TABLE public.ecm_pagamento OWNER TO ecm_user;

--
-- Name: ecm_pagamento_pag_id_seq; Type: SEQUENCE; Schema: public; Owner: ecm_user
--

CREATE SEQUENCE public.ecm_pagamento_pag_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.ecm_pagamento_pag_id_seq OWNER TO ecm_user;

--
-- Name: ecm_pagamento_pag_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ecm_user
--

ALTER SEQUENCE public.ecm_pagamento_pag_id_seq OWNED BY public.ecm_pagamento.pag_id;


--
-- Name: ecm_status_pagamento; Type: TABLE; Schema: public; Owner: ecm_user
--

CREATE TABLE public.ecm_status_pagamento (
    stp_id integer NOT NULL,
    stp_descricao character varying(50) NOT NULL,
    stp_criado_em timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


ALTER TABLE public.ecm_status_pagamento OWNER TO ecm_user;

--
-- Name: ecm_status_pagamento_stp_id_seq; Type: SEQUENCE; Schema: public; Owner: ecm_user
--

CREATE SEQUENCE public.ecm_status_pagamento_stp_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.ecm_status_pagamento_stp_id_seq OWNER TO ecm_user;

--
-- Name: ecm_status_pagamento_stp_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ecm_user
--

ALTER SEQUENCE public.ecm_status_pagamento_stp_id_seq OWNED BY public.ecm_status_pagamento.stp_id;
...
--
-- Name: ecm_tipo_pagamento; Type: TABLE; Schema: public; Owner: ecm_user
--

CREATE TABLE public.ecm_tipo_pagamento (
    tpg_id integer NOT NULL,
    tpg_descricao character varying(50) NOT NULL,
    tpg_criado_em timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


ALTER TABLE public.ecm_tipo_pagamento OWNER TO ecm_user;

--
-- Name: ecm_tipo_pagamento_tpg_id_seq; Type: SEQUENCE; Schema: public; Owner: ecm_user
--

CREATE SEQUENCE public.ecm_tipo_pagamento_tpg_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.ecm_tipo_pagamento_tpg_id_seq OWNER TO ecm_user;

--
-- Name: ecm_tipo_pagamento_tpg_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ecm_user
--

ALTER SEQUENCE public.ecm_tipo_pagamento_tpg_id_seq OWNED BY public.ecm_tipo_pagamento.tpg_id;
...
--
-- Name: ecm_cartao_pagamento crp_id; Type: DEFAULT; Schema: public; Owner: ecm_user
--

ALTER TABLE ONLY public.ecm_cartao_pagamento ALTER COLUMN crp_id SET DEFAULT nextval('public.ecm_cartao_pagamento_crp_id_seq'::regclass);
...
--
-- Name: ecm_pagamento pag_id; Type: DEFAULT; Schema: public; Owner: ecm_user
--

ALTER TABLE ONLY public.ecm_pagamento ALTER COLUMN pag_id SET DEFAULT nextval('public.ecm_pagamento_pag_id_seq'::regclass);


--
-- Name: ecm_status_pagamento stp_id; Type: DEFAULT; Schema: public; Owner: ecm_user
--

ALTER TABLE ONLY public.ecm_status_pagamento ALTER COLUMN stp_id SET DEFAULT nextval('public.ecm_status_pagamento_stp_id_seq'::regclass);
...
--
-- Name: ecm_tipo_pagamento tpg_id; Type: DEFAULT; Schema: public; Owner: ecm_user
--

ALTER TABLE ONLY public.ecm_tipo_pagamento ALTER COLUMN tpg_id SET DEFAULT nextval('public.ecm_tipo_pagamento_tpg_id_seq'::regclass);
...
--
-- Name: ecm_cartao_pagamento ecm_cartao_pagamento_pkey; Type: CONSTRAINT; Schema: public; Owner: ecm_user
--

ALTER TABLE ONLY public.ecm_cartao_pagamento
    ADD CONSTRAINT ecm_cartao_pagamento_pkey PRIMARY KEY (crp_id);
...
--
-- Name: ecm_pagamento ecm_pagamento_pag_uuid_key; Type: CONSTRAINT; Schema: public; Owner: ecm_user
--

ALTER TABLE ONLY public.ecm_pagamento
    ADD CONSTRAINT ecm_pagamento_pag_uuid_key UNIQUE (pag_uuid);


--
-- Name: ecm_pagamento ecm_pagamento_pkey; Type: CONSTRAINT; Schema: public; Owner: ecm_user
--

ALTER TABLE ONLY public.ecm_pagamento
    ADD CONSTRAINT ecm_pagamento_pkey PRIMARY KEY (pag_id);


--
-- Name: ecm_status_pagamento ecm_status_pagamento_pkey; Type: CONSTRAINT; Schema: public; Owner: ecm_user
--

ALTER TABLE ONLY public.ecm_status_pagamento
    ADD CONSTRAINT ecm_status_pagamento_pkey PRIMARY KEY (stp_id);


--
-- Name: ecm_status_pagamento ecm_status_pagamento_stp_descricao_key; Type: CONSTRAINT; Schema: public; Owner: ecm_user
--

ALTER TABLE ONLY public.ecm_status_pagamento
    ADD CONSTRAINT ecm_status_pagamento_stp_descricao_key UNIQUE (stp_descricao);
...
--
-- Name: ecm_tipo_pagamento ecm_tipo_pagamento_pkey; Type: CONSTRAINT; Schema: public; Owner: ecm_user
--

ALTER TABLE ONLY public.ecm_tipo_pagamento
    ADD CONSTRAINT ecm_tipo_pagamento_pkey PRIMARY KEY (tpg_id);


--
-- Name: ecm_tipo_pagamento ecm_tipo_pagamento_tpg_descricao_key; Type: CONSTRAINT; Schema: public; Owner: ecm_user
--

ALTER TABLE ONLY public.ecm_tipo_pagamento
    ADD CONSTRAINT ecm_tipo_pagamento_tpg_descricao_key UNIQUE (tpg_descricao);
...
CREATE INDEX idx_cartao_pagamento_pagamento ON public.ecm_cartao_pagamento USING btree (pag_id);
...
CREATE INDEX idx_pagamento_status ON public.ecm_pagamento USING btree (stp_id);
...
CREATE INDEX idx_pagamento_uuid ON public.ecm_pagamento USING btree (pag_uuid);
...
CREATE INDEX idx_pagamento_venda ON public.ecm_pagamento USING btree (ven_id);
...
--
-- Name: ecm_pagamento trg_gerar_trigrama_pagamento; Type: TRIGGER; Schema: public; Owner: ecm_user
--

CREATE TRIGGER trg_gerar_trigrama_pagamento BEFORE INSERT ON public.ecm_pagamento FOR EACH ROW WHEN ((new.pag_uuid IS NULL)) EXECUTE FUNCTION public.gerar_trigrama_pagamento();
...
--
-- Name: ecm_cartao_pagamento ecm_cartao_pagamento_pag_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ecm_user
--

ALTER TABLE ONLY public.ecm_cartao_pagamento
    ADD CONSTRAINT ecm_cartao_pagamento_pag_id_fkey FOREIGN KEY (pag_id) REFERENCES public.ecm_pagamento(pag_id) ON DELETE CASCADE;
...
--
-- Name: ecm_pagamento ecm_pagamento_stp_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ecm_user
--

ALTER TABLE ONLY public.ecm_pagamento
    ADD CONSTRAINT ecm_pagamento_stp_id_fkey FOREIGN KEY (stp_id) REFERENCES public.ecm_status_pagamento(stp_id);


--
-- Name: ecm_pagamento ecm_pagamento_tpg_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ecm_user
--

ALTER TABLE ONLY public.ecm_pagamento
    ADD CONSTRAINT ecm_pagamento_tpg_id_fkey FOREIGN KEY (tpg_id) REFERENCES public.ecm_tipo_pagamento(tpg_id);


--
-- Name: ecm_pagamento ecm_pagamento_ven_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ecm_user
--

ALTER TABLE ONLY public.ecm_pagamento
    ADD CONSTRAINT ecm_pagamento_ven_id_fkey FOREIGN KEY (ven_id) REFERENCES public.ecm_venda(ven_id) ON DELETE CASCADE;
...
\unrestrict iPHLNda8EeZuY3h2fAciakkbpy7g0r6dWYzTO1ym1il0SJWrEb50kktRfUU20ps
